...
describe('starkSigAuthenticator', () => {
  const starkSigAuthenticator = createStarkSigAuthenticator();

  it('should return type', () => {
    expect(starkSigAuthenticator.type).toBe('starkSig');
  });

  it('should create call', () => {
    const call = starkSigAuthenticator.createProposeCall(proposeEnvelope, {
