...
describe('ethTxAuthenticator', () => {
  const starkTxAuthenticator = createStarkTxAuthenticator();

  it('should return type', () => {
    expect(starkTxAuthenticator.type).toBe('starkTx');
  });

  it('should create call', () => {
    const call = starkTxAuthenticator.createProposeCall(proposeEnvelope, {
